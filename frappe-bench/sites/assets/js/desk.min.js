...
frappe.ui.misc.about = function () {
	if (!frappe.ui.misc.about_dialog) {
		...
		<p><i class='fa fa-globe fa-fw'></i>\
			Website: <a href='https://frappe.io' target='_blank'>https://aceplc.com</a></p>\
		<p><i class='fa fa-github fa-fw'></i>\
			Source: <a href='https://aceple.com' target='_blank'>https://aceplc.com</a></p>\
		<hr>\
		<h4>Installed Apps</h4>\
		<div id='about-app-versions'>Loading versions...</div>\
		<hr>\
		<p class='text-muted'>&copy; Aceplc.com and developers  </p> \
		</div>", frappe.app));
